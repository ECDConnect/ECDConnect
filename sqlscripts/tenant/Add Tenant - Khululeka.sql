...
do $$
declare
	tenantId 				uuid := '1c50abab-aeb6-4de4-8db9-fc41e4745232'::uuid;
	tenantOrgName			text := 'Khululeka';
	tenantAppName			text := 'KHULUconnect';
	tenantSiteAddress		text := 'khululeka.ecdconnect.co.za';
	tenantAdminSiteAddress	text := 'portal-khululeka.ecdconnect.co.za';
	tenantOrgEmail			text := 'KHULU@khululeka.org.za';
	moodleCohort			text := 'khululeka';
	userSuperAdmin1UserName	text := 'KHULUSuperAdmin1';
	userSuperAdmin1Email	text := 'comms@khululeka.org.za';
	userSuperAdmin2UserName text := 'KHULUSuperAdmin2';
	userSuperAdmin2Email	text := 'KHULU@khululeka.org.za';
	...
	smsProviderBulkSMSTokenID			text := '7984CD4F46214CF7B45F494AA1DA9E6C-01-5';
	smsProviderBulkSMSTokenSecret		text := '#5xQN*QTs3*li*sA86FvCd1*kD7i6';
	smsProviderBulkSMSTokenBasicAuth	text := 'Nzk4NENENEY0NjIxNENGN0I0NUY0OTRBQTFEQTlFNkMtMDEtNTojNXhRTipRVHMzKmxpKnNBODZGdkNkMSprRDdpNg==';
