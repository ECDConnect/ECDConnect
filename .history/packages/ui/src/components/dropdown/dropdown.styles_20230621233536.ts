...
export const dropdownClearWrapper =
  'font-body mt-1 inline-flex items-center justify-between origin-top-right right-0 w-full rounded-md border  font-medium hover:bg-gray-50 focus:border-secondary focus:ring-1 focus:ring-secondary';
...
export const getDropDownFill = (
  ...
  switch (fillType) {
    case 'clear':
      return classNames(dropdownClearWrapper, `bg-${fillColor} border-2 border-red`);
    case 'filled':
    default:
