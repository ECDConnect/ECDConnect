...
export const menuItem = 'block p-2 text-textMid font-h2 cursor-pointer hover:bg-secondary hover:text-white';
export const menuItemSm =
  'block px-4 py-2 text-textMid font-h1 text-sm cursor-pointer';
export const menuItemSelected =
  'font-h1 block px-4  cursor-pointer text-textDark';
...
export const getDropDownFill = (
  ...
  switch (fillType) {
    case 'outlined':
      return classNames('', `border-2 rounded-md border-${fillColor} bg-${fillColor} focus:bg-transparent text-white`);
    case 'clear':
