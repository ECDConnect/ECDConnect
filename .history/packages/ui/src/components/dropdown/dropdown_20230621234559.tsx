    ...
    () => (
      <div className="relative">
        <input
          ...
          className={(fillType === 'outlined') ? 'text-white w-80':classNames(
            styles.title,
                    ...
                    return (
                      <div className={styles.menuItemWrapper} key={index}>
                        <Menu.Item>
                          ...
                          >
                            <div
                              className={`flex flex-row gap-2.5 text-${item.value === selectedItem?.value
                                  ? 'dark font-medium'
                                  : 'textMid font-normal'
                                }`}
                            >
                              <CheckCircleIcon
                                className={`h-22 w-22 cursor-pointer text-${item.value === selectedItem?.value
                                    ? 'blue-accent3'
                                    : 'primaryAccent2'
                                  }`}
                              />
