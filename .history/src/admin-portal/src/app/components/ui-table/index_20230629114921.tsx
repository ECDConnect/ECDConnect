      ...
      <Table
        ...
        styling={{
          ...
          footer: options.footer || {
            ...
            page_numbers: `page-numbers border-2 border-secondary bg-secondary z-10 text-white relative inline-flex items-center px-4 py-2 text-sm font-medium w-4 rounded-2xl mx-2`,
          },
        }}
        columns={makeColumns()}
        rows={makeRows()}
