      ...
      <Table
        ...
        styling={{
          ...
          table_body: {
            ...
            table_data:
              'truncate w-20 px-6 pt-2 pb-2 text-sm font-medium text-white border-b border-gray-100',
          },
          footer:  {
            ...
            statistics: {
              ...
              } text-white table-stats md:w-auto md:flex-row`,
              bold_numbers: `text-white font-bold`,
            },
            page_numbers: `page-numbers border-2 border-secondary bg-secondary z-10 text-white relative inline-flex items-center px-4 py-2 text-sm font-medium w-4 rounded-2xl mx-1`,
          },
        }}
        columns={makeColumns()}
        rows={makeRows()}
