    ...
    if (typeof display_value === 'boolean') {
      ...
      rowValue = (
        <span
          ...
          className={classNames(
            'inline-flex rounded-full px-2 text-xs font-semibold leading-5 text-white cursor-pointer',
      ...
      rowValue =
        typeof display_value === 'string' ? (
          <a className="inline-block overflow-ellipsis cursor-pointer" onClick={() => viewSelectedRow(row)} >
