      ...
      <Table
        ...
        styling={{
          ...
          footer: options.footer || {
            main: `${rows.length < 10 ? 'hidden' : ''} mt-8 mx-5 table-footer border-none`,
            statistics: {
              main: `${
            ...
            page_numbers: `page-numbers z-10 text-primary relative inline-flex items-center px-4 py-2 text-sm font-medium w-4 rounded-xl mx-2`,
          },
        }}
        columns={makeColumns()}
        rows={makeRows()}
