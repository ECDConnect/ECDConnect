    ...
    <div className="table-top w-full overflow-hidden rounded-lg shadow-lg">
      <Table
        ...
        styling={{
          ...
          main: 'rounded-lg',
          table_head: {
            table_row: ` mb-10 border-gray-100 border-2 border-b border-secondary`,
            table_data: `px-6 py-3 pl-6 pr-6 pt-3 pb-3 bg-infoBb text-left text-xs font-medium text-gray-500 uppercase tracking-wider leading-none bg-D2F1F9`,
          },
          table_body: {
            main: ``,
            // table_row: 'border-none bg-secondary ',
            table_row: 'border-none py-8',
