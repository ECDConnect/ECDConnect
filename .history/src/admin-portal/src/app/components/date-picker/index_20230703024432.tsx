...
function CustomDateRangePicker(props: any
    ...
    return (
        <div>
            <button
                className="border-2 border-secondary hover:bg-secondary hover:text-white text-secondary font-bold py-2 px-4 rounded"
            ...
            >
                ...
                <ChevronDownIcon className='text-secondary'></ChevronDownIcon>
            </button>
