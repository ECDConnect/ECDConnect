  ...
  return (
    <div className="bg-red flex min-w-0 flex-col xl:flex">
      ...
      <div className="m-10 rounded-2xl lg:min-w-0 lg:flex-1">
        ...
        <div className="m-10 rounded-2xl bg-white  lg:min-w-0 lg:flex-1 border-l-primary  border-l-8 border-2 border-primary">
          <div className="h-full py-6 px-4 sm:px-6 lg:px-8">
            {/* Start main area*/}
        ...
        <div className="m-10 mt-12 mb-12 rounded-2xl bg-white  lg:min-w-0 lg:flex-1 border-l-errorMa  border-l-8 border-2 border-errorMain">
          <div className="h-full py-6 px-4 sm:px-6 lg:px-8">
            {/* Start main area*/}
            {personalEditInformationComponent}
            <h3 className='pb-10 border-b-4 border-dashed text-xl mb-14'> Personal information 1</h3>
        ...
        <div className="m-10 mt-12 mb-12 rounded-2xl bg-white  lg:min-w-0 lg:flex-1 border-l-errorMa  border-l-8 border-2 border-errorMain">
          <div className="h-full py-6 px-4 sm:px-6 lg:px-8">
            ...
            <h3 className='pb-10 border-b-4 border-dashed text-xl mb-14'> Personal information 2</h3>
