        ...
        <div className="pl-4 flex flex-row w-full justify-between">
          ...
          <div className='flex justify-end p-4'>
            ...
            {props.location.state?.component !== 'chw' && <button onClick={() => setEditActive(!editActive)} id="dropdownHoverButton"
              className="text-white bg-secondary hover:bg-gray-300 focus:border-secondary  text-center focus:ring-2 focus:outline-none focus:ring-secondary font-medium rounded-lg text-sm  inline-flex items-center dark:bg-secondary dark:hover:bg-grey-300 dark:focus:ring-secondary"
