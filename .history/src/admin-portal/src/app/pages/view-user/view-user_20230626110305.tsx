...
import { DeleteUser, GetHealthCareWorkerByUserId, GetHealthCareWorkerHighlights, GetTenantContext, GetUserById, ResetUserPassword, UpdatePractitioner, UpdateUser, UserModelInput, healthCareWorkerVisitStatus } from '@ecdlink/graphql';
                  ...
                  <>
                    <div className="space-y-0">
                      ...
                      <div className="grid grid-cols-1 ">
                        ...
                        {
                          props.location.state?.component !== 'chw' && <div className="my-4 sm:col-span-3 w-6/12">
                            <FormField
                              label={'Email *'}
                              nameProp={'email'}
                              register={userDetailRegister}
