...
export function ViewUser(props: any) {
  ...
  useEffect(() => {
    ...
    console.log(summaryData?.healthCareWorkerSummaryForPeriod)
              ...
              <div className="h-full py-6 px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-row justify-evenly pt-4 text-current">
                  <p className="px-4 py-2  text-xl">
                    <span className="p-2  text-3xl">{summaryData?.healthCareWorkerSummaryForPeriod?.totalPregnantMoms}</span>pregnant moms
                  </p>
                  <p className="px-4 py-2  text-xl">
                    <span className="p-2  text-3xl">{summaryData?.healthCareWorkerSummaryForPeriod?.totalChildren}</span>children
                  </p>
                  <p className="px-4 py-2  text-xl">
                    <span className="p-2  text-3xl">{summaryData?.healthCareWorkerSummaryForPeriod?.totalClientsVisited}</span>clients visited
                  </p>
                  <p className="px-4 py-2  text-xl">
                    <span className="p-2  text-3xl">{summaryData?.healthCareWorkerSummaryForPeriod?.totalFoldersOpened}</span>folders opened
                  </p>
                </div>
                {/* End main area */}
              </div>
              ...
              <div className="border-l-errorMain  border-errorMain m-10 mb-12  rounded-2xl border-2 border-l-8  bg-white lg:min-w-0 lg:flex-1">
                <div className="h-full py-6 px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="flex flex-col justify-evenly pt-4 text-current">
                    ...
                    <p className="px-4py-2 text-xl">
                      <span className="text-errorMain p-2 text-3xl">{summaryData?.healthCareWorkerSummaryForPeriod?.totalPregnantMomsWithUrgentIssues
                      }</span>
                      pregnant moms have urgent issues
                    </p>

                    <p className="px-4py-2 text-xl">
                      <span className="text-errorMain p-2 text-3xl">{summaryData?.healthCareWorkerSummaryForPeriod?.totalCaregiversAndChildrenWithUrgentIssues}</span>
                ...
                <div className="h-full py-6 px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="flex flex-col justify-evenly pt-4 text-current">
                    ...
                    <p className="px-4py-2 text-xl">
                      <span className="text-alertMain p-2 text-3xl">
                        {
                          summaryData?.healthCareWorkerSummaryForPeriod?.totalCaregiversAndChildrenWithUrgentIssues
                        }
                      </span>
