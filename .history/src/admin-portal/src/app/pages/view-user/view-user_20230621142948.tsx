    ...
    <div className="bg-red flex min-w-0 flex-col xl:flex">
      <div className='justify-self col-end-3 '>
        <button
          ...
          type="button"
          className="text-secondary outline-none inline-flex w-full items-center border border-transparent px-4 py-2 text-[12px] font-medium "
        >
          <ArrowLeftIcon className="text-secondary h-4 w-4 mr-2"> </ArrowLeftIcon>
          Back <span className="text-black pl-4">/ View User</span>
        </button>
      </div>
