      ...
      <div className="m-10 rounded-2xl lg:min-w-0 lg:flex-1">
        ...
        <div className="m-10 my-6 mt-4 rounded-2xl bg-white  lg:min-w-0 lg:flex-1 border-l-secondary  border-l-8 border-2 border-secondary">
          <div className="h-full py-6 px-4 sm:px-6 lg:px-8">
            ...
            <div className='flex flex-row justify-start pt-4 text-current'>
              <p className='text-xl px-4'><span className="text-2xl p-2">44</span>pregnant moms</p>
              <p className='text-xl px-4'><span className="text-2xl  p-2">44</span>children</p>

              <p className='text-xl px-4'><span className="text-2xl  p-2">44</span>clients visited</p>
              <p className='text-xl px-4'><span className="text-2xl  p-2">44</span>folders opened</p>
