        ...
        <div className='flex flex-row'>
          ...
          <div className="m-10  mb-12 rounded-2xl bg-white  lg:min-w-0 lg:flex-1 border-l-errorMain  border-l-8 border-2 border-errorMain">
            <div className="h-full py-6 px-4 sm:px-6 lg:px-8">
              ...
              <p className='text-xl px-4 py-2 flex flex-row'><span className="text-4xl pb-2 px-2">44</span>visits missed</p>
              <p className='text-xl px-4 py-2'><span className="text-3xl p-2">44</span>pregnant moms have urgent issues</p>

              <p className='text-xl px-4py-2'><span className="text-3xl p-2">44</span>caregivers & children have urgent issues</p>
            </div>
              {/* End main area */}
            </div>
          </div>
