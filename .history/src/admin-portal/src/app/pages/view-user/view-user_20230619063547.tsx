    ...
    <div className="bg-red flex min-w-0 flex-col xl:flex">
      ...
      <div className="m-10 rounded-2xl lg:min-w-0 lg:flex-1">
        ...
        <div className="m-10 mt-0 rounded-2xl bg-white  lg:min-w-0 lg:flex-1 border-l-primary  border-l-8 border-2 border-primary">
          <div className="h-full py-6 px-4 sm:px-6 lg:px-8">
            {/* Start main area*/}
            <h3 className='pb-2 border-b-4 border-dashed text-xl mb-0'> Personal information </h3>
            {
              editActive ? personalEditInformationComponent() :
                <div className='flex flex-row justify-start py-2 text-primary'>
                  <p className='text-2xl px-4'>ID: 1234567891234</p>
                  <p className='text-2xl px-4'> Cellphone: 067 891 2345</p>
                  <p className='text-2xl px-4'>WhatsApp:  072 891 2345</p>
