        ...
        <div className="m-10 mt-0 rounded-2xl bg-white  lg:min-w-0 lg:flex-1 border-l-primary  border-l-8 border-2 border-primary">
                    ...
                    <div className="grid grid-cols-1 ">
                      <div className="my-4 sm:col-span-3 w-6/12">
                        <FormField
                          ...
                          nameProp={'idNumber'}
                          register={userDetailRegister}
                          error={userDetailFormErrors.idNumber?.message}
                      ...
                      <div className="my-4 sm:col-span-3 w-6/12">
                        <FormField
                          ...
                          register={userDetailRegister}
                          error={userDetailFormErrors.phoneNumber?.message}
          ...
          <div className='flex justify-end p-4'>
            <button onClick={() => setEditActive(!editActive)} id="dropdownHoverButton"
              className="text-white bg-secondary hover:bg-gray-300 focus:border-secondary  text-center focus:ring-2 focus:outline-none focus:ring-secondary font-medium rounded-lg text-sm py-2.5 px-12 inline-flex items-center dark:bg-secondary dark:hover:bg-grey-300 dark:focus:ring-secondary"
