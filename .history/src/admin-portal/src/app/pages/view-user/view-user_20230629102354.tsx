                  ...
                  dialog({
                    ...
                    render: (onSubmit: any, onCancel: any) => (
                      <AlertModal
                        ...
                        message={`${chwData?.GetHealthCareWorkerById.user?.firstName} will lose their access to AppName immediately. Make sure you have communicated with them before deactivating them.`}
                        onCancel={onCancel}
                        onSubmit={() => {
                          onSubmit();
                          deleteUser({
