  ...
  return (
    <div className="bg-red flex min-w-0 flex-col xl:flex">
      ...
      <div className="m-10 rounded-2xl lg:min-w-0 lg:flex-1">
        <div className="h600 py-6 px-4 sm:px-6 lg:px-8">
          {/* Start main area*/}

          <div className="flex h-full " style={{ minHeight: '30rem' }}>
            <div className="p-6 dark:bg-gray-900 dark:text-gray-100 sm:p-12">
              <div
                className="flex flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-0  "
                style={{ width: '50rem' }}
              >
                <img
                  src="https://source.unsplash.com/75x75/?portrait"
                  alt=""
                  className="h-30 w-30 mr-6 flex-shrink-0 self-center rounded-full md:justify-self-start"
                />
        ...
        <div className="m-10 rounded-2xl bg-white  lg:min-w-0 lg:flex-1 border-l-current bottom-2 border-l-8">
          <div className="h-full py-6 px-4 sm:px-6 lg:px-8">
            {/* Start main area*/}
