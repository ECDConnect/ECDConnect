            ...
            <h3 className='pb-2 border-b-4 border-dashed text-xl '> Personal information </h3>
            {
              editActive ? <form key={"formKey"} className="space-y-8 divide-y divide-gray-200">
                <div className="space-y-0">
                  <p className='text-md py-1 mt-4'>Which kind of identification do you have for Palesa?</p>
                  <div className="flex flex-row">
                    ...
                    {<Button
                      className={' w-4/12 rounded-md mr-6'}
                      type="filled"
                      isLoading={loading}
                      color="tertiary"
                ...
                {<Button
                  className={'mt-3 w-4/12 rounded-md mr-6'}
                  type="filled"
                  isLoading={loading}
                  color="secondary"
                  disabled={!isUserDetailValid}
