              ...
              >
                ...
                <div className='sm: pt-12'>
                  ...
                  {userData?.userById.roles.map((i: any, index: number) => {
                    return <div
                      key={i.id}
                      className="bg-uiMid m-1 rounded-full py-1 my-2 px-3 text-xs text-white w-6/12 flex justify-center flex-row"
                    >
            ...
            <h3 className='pb-2 border-b-4 border-dashed text-xl '> Personal information </h3>
            {
              editActive ? personalEditInformationComponent() :
                <div className='flex flex-row justify-start pt-4 text-current'>
                  ...
                  <p className='text-xl px-4'> Cellphone: {userData?.userById?.idNumber}</p>
                  <p className='text-xl px-4'>WhatsApp: {userData?.userById?.idNumber}</p>
