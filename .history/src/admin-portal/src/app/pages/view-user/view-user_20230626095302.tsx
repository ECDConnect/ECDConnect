...
import { DeleteUser, GetHealthCareWorkerByUserId, GetHealthCareWorkerHighlights, GetTenantContext, GetUserById, ResetUserPassword, UpdateUser, UserModelInput, healthCareWorkerVisitStatus } from '@ecdlink/graphql';
...
export function ViewUser(props: any) {
  ...
  const [ getChwById, { data: chwResponseData, refetch }] = useLazyQuery(GetHealthCareWorkerByUserId, {
    variables: {
      userId: '',
    },
  ...
  const [getUserById, { data:userResponseData }] = useLazyQuery(GetUserById, {
    variables: {
      userId: '',
    },
    fetchPolicy: 'network-only',
  ...
  let userData = userResponseData.userById ?? chwResponseData
    ...
    <div className="bg-red flex min-w-0 flex-col xl:flex">
      ...
      <div className="m-10 rounded-2xl lg:min-w-0 lg:flex-1">
            ...
            <div className="p-6 dark:bg-gray-900 dark:text-gray-100 sm:p-12">
              ...
              >
                ...
                <div className='sm: pt-12'>
                  <p className='text-3xl font-normal '>{userData?.fullName}</p>
        ...
        <div className="pl-4 flex flex-row w-full justify-between">
          ...
          <p className="text-gray-500 mt-3 text-sm">User added to {data?.tenantContext.applicationName}: {userData?.StartDate}</p>
