...
import { DeleteUser, GetHealthCareWorkerHighlights, GetTenantContext, GetUserById, ResetUserPassword, UpdateUser, UserModelInput } from '@ecdlink/graphql';
...
export function ViewUser(props) {
  ...
  useEffect(() => {
    ...
    // console.log("hcw", healthCareWorkerHighlightsData.data)
  }, [userId])

  const { hasPermission } = useUser();
  console.log(healthCareWorkerHighlightsData)
          ...
          </div>}
        {
          ...
          <div className="m-10  mb-10 rounded-2xl bg-white  lg:min-w-0 lg:flex-1 border-l-successMain  border-l-8 border-2 border-successMain">
            <div className="h-full py-6 px-4 sm:px-6 lg:px-8">
              ...
              <div className='flex flex-col justify-evenly pt-4 text-current'>
                <p className='text-xl px-4py-2'><span className="text-3xl p-2 text-successMain">{healthCareWorkerHighlightsData?.healthCareWorkerHighlights.totalThisWeekNewClients}</span>total This Week New Clients</p>
                <p className='text-xl px-4py-2'><span className="text-3xl p-2 text-successMain">{healthCareWorkerHighlightsData?.healthCareWorkerHighlights.totalThisWeekGrowthMonitored}</span>totalThisWeekGrowthMonitored</p>
                <p className='text-xl px-4py-2'><span className="text-3xl p-2 text-successMain">{healthCareWorkerHighlightsData?.healthCareWorkerHighlights.totalThisWeekFamilyVisits}</span>totalThisWeekFamilyVisits</p>
                <p className='text-xl px-4py-2'><span className="text-3xl p-2 text-successMain">{healthCareWorkerHighlightsData?.healthCareWorkerHighlights.totalLastWeekFamilyVisits}</span>totalLastWeekFamilyVisits</p>
                <p className='text-xl px-4py-2'><span className="text-3xl p-2 text-successMain">{healthCareWorkerHighlightsData?.healthCareWorkerHighlights.totalLastWeekGrowthMonitored}</span>totalLastWeekGrowthMonitored</p>
                <p className='text-xl px-4py-2'><span className="text-3xl p-2 text-successMain">{healthCareWorkerHighlightsData?.healthCareWorkerHighlights.totalLastWeekNewClients}</span>totalLastWeekNewClient</p>
              </div>
