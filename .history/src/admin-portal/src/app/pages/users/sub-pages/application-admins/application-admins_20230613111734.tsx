...
export default function ApplicationAdmins() {
  ...
  useEffect(() => {
    if (startDateRef.current && endDateRef.current) {
      startDateRef.current.click(); // Open the calendar for the start date input
      endDateRef.current.click(); // Open the calendar for the end date input
    }
  }, []);
        ...
        <div className="flex flex-col">
          <div className="pb-5 sm:flex sm:items-center sm:justify-between">
            <div className="pb-5 sm:flex sm:items-center sm:justify-between">
              ...
              <div className="mt-3 sm:mt-0 sm:ml-4 sm:flex sm:items-center">
                {hasPermission(PermissionEnum.create_user) && (
                  <button
                    onClick={displayUserPanel}
                    type="button"
                    className="bg-secondary hover:bg-uiLight focus:outline-none inline-flex w-full sm:w-auto items-center rounded-md border border-transparent px-4 py-2 text-sm font-medium text-white shadow-sm focus:ring-2 focus:ring-offset-2"
                  >
