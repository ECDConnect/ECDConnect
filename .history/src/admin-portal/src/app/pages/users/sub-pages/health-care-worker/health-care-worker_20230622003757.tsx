            ...
            <div className="text-body w-full sm:flex ">
              <div className="text-body sm:flex flex-col ">
                <div className="relative ">
                  ...
                  <input
                    className="bg-uiBg focus:outline-none sm:text-md block w-96 rounded-md py-3 pl-10 pr-3 leading-5 text-gray-900 placeholder-gray-600 focus:border-white focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-white"
