...
export default function ApplicationAdmins() {
  ...
  className={`inline-flex w-full justify-center gap-x-1.5 rounded-md px-3 py-2 text-sm font-normal ${
    showDropDownFilter ? 'text-white bg-secondary border-2 border-primary' : 'text-secondary bg-white'
...
>
  ...
  <svg
    className={`-mr-1 h-5 w-5 ${
      showDropDownFilter ? 'text-white hover:text-secondary' : 'text-secondary hover:text-white'
    }`}
    viewBox="0 0 20 20"
    fill="currentColor"
    aria-hidden="true"
