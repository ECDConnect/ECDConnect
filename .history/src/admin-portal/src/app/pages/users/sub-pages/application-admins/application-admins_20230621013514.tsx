                      ...
                      <div className="relative inline-block text-left">
                        <div>
                          <button
                            ...
                            className={`inline-flex w-full justify-center gap-x-1.5 rounded-md px-3 py-2 text-sm font-normal ${!showDropDownFilter ? 'text-white bg-secondary' : 'text-secondary bg-white'
