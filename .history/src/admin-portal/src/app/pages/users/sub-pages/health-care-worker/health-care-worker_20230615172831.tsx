            ...
            <div className="text-body w-full sm:flex  sm:justify-around">
              <div className="text-body w-8/12 sm:flex flex-col sm:justify-around">
                <div className="relative w-10/12">
                  ...
                  <input
                    className="bg-uiBg focus:outline-none sm:text-md block w-full rounded-md py-3  pr-0 leading-5 text-gray-900 placeholder-gray-600 focus:border-white focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-white"
