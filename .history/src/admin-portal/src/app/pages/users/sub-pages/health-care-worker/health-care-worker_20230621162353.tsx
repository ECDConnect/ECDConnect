                    ...
                    <div className='flex justify-end'>
                      <div className="w-60">
                        <button
                          ...
                          type="button"
                          className="text-secondary w-full hover:bg-secondary hover:text-white outline-none inline-flex items-center rounded-md border border-transparent px-4 py-2 text-sm font-medium  "
                        >
                          Clear All
                        </button>
                      </div>
