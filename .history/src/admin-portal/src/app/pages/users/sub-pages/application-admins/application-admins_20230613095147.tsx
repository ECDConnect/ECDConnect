...
export default function ApplicationAdmins() {
        ...
        <div className="flex flex-col">
          <div className="pb-5 sm:flex sm:items-center sm:justify-between">
            <div className="text-body w-6/12 sm:flex  sm:justify-around">
              <div className="text-body w-6/12 sm:flex flex-col sm:justify-around">
                ...
                <div className="mx-4 w-3/12 sm:flex flex-row">
                  <span className="flex w-full items-center text-lg font-medium leading-6 text-gray-900">
                    <div className="sm:col-span-3">
                      <input
                        ...
                        placeholder="Filter by date invited"
                      />
                    </div>
                  </span>
                </div>
  ...
  <div className="pb-5 sm:flex sm:items-center sm:justify-between w-full">
    <div className="text-body w-full sm:flex  sm:flex-col sm:justify-between">
      <div className="flex items-center">
        <div className="relative">
          ...
          <input
            className="bg-uiBg focus:outline-none sm:text-md block  rounded-md py-3 pl-10 pr-3 leading-5 text-gray-900 placeholder-gray-600 focus:border-white focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-white"
            placeholder="Search by email or name..."
            onChange={search}
          />
        </div>
  ...
  <div className="flex items-center justify-between">
    <button className="bg-primary text-white px-4 py-2 rounded-md">Create</button>
  </div>
</div>
          ...
          <div className="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div className="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
              <div className="overflow-hidden border-b border-gray-200 shadow sm:rounded-lg">
                <UiTable
                  columns={[
                    { field: 'email', use: 'Email / ID Number' },
