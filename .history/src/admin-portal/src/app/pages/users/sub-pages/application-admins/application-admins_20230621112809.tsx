                  ...
                  <div className="flex items-center mt-4 sm:mt-6 flex-row justify-between ">
                    ...
                    <div >
                      <button
                        ...
                        type="button"
                        className="text-secondary hover:bg-secondary hover:text-white outline-none inline-flex w-full items-center rounded-md border border-transparent px-4 py-2 text-sm font-medium text-white shadow-sm "
                      >
                        Clear All
                      </button>
                    </div>
