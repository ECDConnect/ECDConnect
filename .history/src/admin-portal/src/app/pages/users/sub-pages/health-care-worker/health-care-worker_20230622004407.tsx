      ...
      <div>
        <div className="flex flex-col ">
          <div className="pb-5 sm:flex  ">
            <div className="text-body sm:flex flex-row ">
              ...
              <div className="mx-4 w-3/12 flex flex-row">
              ...
              <div className=" w-full mr-10 flex flex-row">
                {hasPermission(PermissionEnum.create_user) && (
                  <button
                    onClick={displayPanel}
                    type="button"
                    className="bg-secondary  hover:bg-uiLight focus:outline-none inline-flex items-center rounded-md border border-transparent px-8 py-2 text-sm  font-medium text-white shadow-sm focus:ring-2 focus:ring-offset-2"
                  >
                    <PlusIcon className="mr-2 h-5 w-5"> </PlusIcon>
                    Add CHWs
                  </button>
                )}
              </div>
