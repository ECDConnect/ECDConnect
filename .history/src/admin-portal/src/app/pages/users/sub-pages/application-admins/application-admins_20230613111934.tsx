              ...
              <div className="text-body w-6/12 sm:flex flex-col sm:justify-around">
                ...
                {showFilter && (
                  <div className="flex items-center mt-4 sm:mt-6">
                    ...
                    <div className="flex flex-col flex-start justify-around mt-20">
                      {isDropdownVisible && (
                        <div
                          id="dropdownDivider"
                          className="z-10  bg-white divide-y divide-gray-100 rounded-lg shadow w-96 dark:bg-gray-700 dark:divide-gray-600 flex"
                        >
