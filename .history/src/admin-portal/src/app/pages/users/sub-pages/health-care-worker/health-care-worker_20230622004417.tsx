              ...
              <div className=" w-full mr-10 ">
                {hasPermission(PermissionEnum.create_user) && (
                  <button
                    ...
                    type="button"
                    className="bg-secondary flex  hover:bg-uiLight focus:outline-none inline-flex items-center rounded-md border border-transparent px-8 py-2 text-sm  font-medium text-white shadow-sm focus:ring-2 focus:ring-offset-2"
                  >
