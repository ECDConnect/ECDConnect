                  ...
                  <div className="flex items-center mt-4 sm:mt-6 ">
                    ...
                    <div>
                      ...
                      <div className="relative inline-block text-left">
                        <div>
                          <button type="button" onClick={() => setShowDropDownFilter(!showDropDownFilter)} className="inline-flex w-full justify-center gap-x-1.5 rounded-md px-3 py-2 text-sm font-normal text-white bg-secondary hover:bg-white hover:text-secondary focus:text-secondary" id="menu-button" aria-expanded="true" aria-haspopup="true">
                            Filter by status
                            <svg className="-mr-1 h-5 w-5 text-white hover:text-secondary" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
