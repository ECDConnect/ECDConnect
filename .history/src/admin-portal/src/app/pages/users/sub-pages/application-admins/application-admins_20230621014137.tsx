                        ...
                        <div>
                          <button
                            ...
                            className={`inline-flex w-full justify-center gap-x-1.5 rounded-md px-3 py-2 text-sm font-normal ${!showDropDownFilter ? 'text-white bg-secondary' : 'text-secondary bg-white border-2 border-secondary'
                              } hover:bg-white hover:border-2 hover:border-secondary`}
                            id="menu-button"
                          ...
                          >
                            Filter by status
                            <svg
                              className={`-mr-1 h-5 w-5 ${!showDropDownFilter ? 'text-white hover:text-secondary' : 'text-secondary hover:text-secondary'
                                }`}
                              viewBox="0 0 20 20"
                              fill="currentColor"
                              aria-hidden="true"
