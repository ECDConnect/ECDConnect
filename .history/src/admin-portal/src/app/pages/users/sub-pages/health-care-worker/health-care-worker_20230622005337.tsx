        ...
        <div className="flex flex-col">
          <div className="pb-5 sm:flex sm:items-center sm:justify-between">
            <div className="text-body w-full sm:flex  sm:justify-around">
              <div className="text-body sm:flex flex-col sm:justify-around">
                <div className="relative ">
                  ...
                  <input
                    className="bg-uiBg focus:outline-none sm:text-md block w-8/12 rounded-md py-3 pl-10 pr-3 leading-5 text-gray-900 placeholder-gray-600 focus:border-white focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-white"
                    placeholder="      Search by email or name..."
                    onChange={search}
                  />
                </div>
                {showFilter && (
                  <div className="flex items-center mt-4 sm:mt-6 flex-row w-full">
                    ...
                    <div className='flex ml-60'>
                      <div className="">
                        <button
                          ...
                          type="button"
                          className="text-secondary hover:bg-secondary hover:text-white outline-none inline-flex w-full items-center rounded-md border border-transparent px-4 py-2 text-sm font-medium "
                        >
                          Clear All
                        </button>
                      </div>
            ...
            <div className="mt-3  sm:mt-0 sm:ml-4 flex flex-row justify-">
              ...
              <div className="mt-0 w-auto pr-5">
                      ...
                      {({ open }) => (
                        <>
                          <div>
                            <Menu.Button
                              type="button"
                              className="bg-primary hover:bg-uiLight py-6 focus:outline-none inline-flex items-center rounded-md border border-transparent px-4 py-2 text-sm font-medium text-white shadow-sm focus:ring-2 focus:ring-offset-2"
                            >
                              <UploadIcon
                                className="h-5 w-5 "
                                aria-hidden="true"
