                      ...
                      <div className="relative inline-block text-left">
                        <div>
                          <button
                            ...
                            className={`inline-flex w-full justify-center gap-x-1.5 rounded-md px-3 py-2 text-sm font-normal hover:border-2 hover:border-secondary ${!showDropDownFilter ? 'text-white bg-secondary' : 'text-secondary bg-white border-2 border-secondary'
                              } hover:bg-white hover:text-secondary focus:text-secondary`}
                            id="menu-button"
