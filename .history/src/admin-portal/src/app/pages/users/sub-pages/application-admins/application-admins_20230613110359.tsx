          ...
          <div className="pb-5 sm:flex sm:items-center sm:justify-between">
            <div className="text-body w-6/12 sm:flex  sm:justify-around">
              <div className="text-body w-6/12 sm:flex flex-col sm:justify-around">
                ...
                {showFilter && (
                  <div className="flex flex-row items-center mt-4 sm:mt-6">
                    <div>
                      <button
                    ...
                    <div className="flex flex-col justify-around">
                      {isDropdownVisible && (
                        <div
                          id="dropdownDivider"
                          className="z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-96 dark:bg-gray-700 dark:divide-gray-600"
                        >
                          <div className="p-4">
                            <input
                              defaultValue=""
