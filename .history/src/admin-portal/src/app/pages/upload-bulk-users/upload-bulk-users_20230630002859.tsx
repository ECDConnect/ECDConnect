...
export default function UploadBulkUser({
  ...
  const [importPractitioners, {loading: loadingCHW}] = useMutation(UploadHealthCareWorkers);
          ...
          >
            ...
            <div className="-ml-4 -mt-2 flex flex-wrap items-center justify-between sm:flex-nowrap">
              ...
              <div className="ml-4 mt-2 flex-shrink-0">
                ...
                >
                  <PaperAirplaneIcon className="mr-4 h-5 w-5 text-white ml-4"> </PaperAirplaneIcon>

                  <Typography
                    type="help"
                    color="white"
                    text={'  Add & invite users'}
                    className='mr-4'
                  ></Typography>
                </Button>
