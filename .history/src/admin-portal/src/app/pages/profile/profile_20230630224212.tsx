...
import { GetUserById, ResetUserPassword, UpdateUser, UserModelInput, FileUpload } from '@ecdlink/graphql';
...
export function Profile(props: any) {
  ...
  const [upload, { loading: UploadLoading }] = useMutation(UpdateUser);
