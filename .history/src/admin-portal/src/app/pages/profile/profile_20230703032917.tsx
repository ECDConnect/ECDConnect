...
import { Button, ProfileAvatar, Typography, getImageSourceFromFileSystem } from '@ecdlink/ui';
...
export function Profile(props: any) {
  ...
  const onSave = async () => {
    ...
    if (avatarFile) {
      await fileUpload({
        variables: {
          file: avatarFile.replace("data:image/jpeg;", ""),
              ...
              <div className="p-6 dark:bg-gray-900 dark:text-gray-100 sm:p-12">
                ...
                >
                  ...
                  <ProfileAvatar
                    dataUrl={avatarFile ?? ''}
                    size={'header'}
                    onPressed={getImageSourceFromFileSystem}
                    hasConsent={true}
                  />
