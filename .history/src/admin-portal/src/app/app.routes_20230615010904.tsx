...
import ApplicationUsers from './pages/users/sub-pages/application-admins/application-admins';
...
import ApplicationAdmins from './pages/users/sub-pages/application-admins-5/application-admins';
...
const UserRoutes: React.FC = () => {
  return (
    <Switch>
      ...
      <Route path={`/users/admins`} component={ApplicationUsers}></Route>
