 ...
 *
 * Returns: local number as string (starts with 0), or false if invalid.
 */
export const formatPhonenumberLocal = (phoneNumber: string): string | false => {
  ...
  if (!validPrefixes.test(localNumber)) return false;
  */
