export const wrapper =
  'w-full rounded-lg flex flex-col justify-between items-start bg-uiBg';
...
export const headerBar = 'flex flex-row flex-nowrap pb-4';
export const levelContainer = 'flex flex-row flex-nowrap pt-2';
