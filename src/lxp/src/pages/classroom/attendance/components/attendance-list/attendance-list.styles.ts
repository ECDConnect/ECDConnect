...
export const contentWrapper = 'flex flex-row justify-between px-4 py-1 border-b border-uiMidDark';
...
export const statusChipsWrapper = (shouldFilter?: boolean) =>
  `flex flex-1 flex-row items-center ${shouldFilter ? 'justify-end' : 'justify-start py-3'}`;
