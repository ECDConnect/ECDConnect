...
import { Button, ButtonGroup, Divider, FormInput, Typography } from '@ecdlink/ui';
...
export const EditProgrammeForm: React.FC<EditProgrammeFormProps> = ({ onSubmit, programme }) => {
  ...
  const { isPrincipleOrLeader, assistants, type } = useWatch<EditProgrammeModel>({
    control: programmeFormControl,
    defaultValue: {},
  });
  ...
  return (
    <div>
      <Typography type={'h1'} text={'Set up your programme'} color={'primary'} className={'my-3'} />
      <div className="space-y-4">
        ...
        <div className={'w-full'}>
          <label className={styles.label}>Are you the principal or leader of the programme?</label>
          <div className="mt-1">
            <ButtonGroup<boolean>
        ...
        {isPrincipleOrLeader !== false && (
          <>
            <FormInput<EditProgrammeModel>
              label={'How many other SmartStart practitioners work at your site?'}
              register={programmeFormRegister}
            ...
            <FormInput<EditProgrammeModel>
              label={'How many non-SmartStart trained teaching assistants do have?'}
              register={programmeFormRegister}
            ...
            <FormInput<EditProgrammeModel>
              label={'How many other assistants do you have, not counting the assistants above?'}
              register={programmeFormRegister}
              nameProp={'assistants'}
              placeholder={'Enter a number'}
              type={'number'}
            ...
            {assistants && assistants > 0 && (
              <div className={'w-full'}>
                <label className={styles.label}>Do you teach any classes yourself?</label>
                <div className="mt-1">
                  <ButtonGroup<boolean>
                    options={yesNoOptions}
                    onOptionSelected={(value: boolean | boolean[]) =>
