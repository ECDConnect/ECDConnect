...
export const Utilities: React.FC<AddExpenseState> = ({
  onBack,
  onSubmit,
  expenseItem,
}) => {
    ...
    >
      <div className="mb-3 w-full justify-center">
        <Typography
          type="h2"
          color="primary"
          text="Utilities (electricity, water & other running costs)"
        />
        ...
        <FormInput<ExpensesModel>
          ...
          nameProp={'amount'}
          register={register}
          placeholder={!disabled ? 'e.g. R 700.00' : ''}
          className="mt-2"
          type={'text'}
        ...
        <FormInput<ExpensesModel>
          ...
          nameProp={'notes'}
          register={register}
          placeholder={!disabled ? 'e.g. Airtime to call caregivers' : ''}
          className="mt-2"
          disabled={disabled}
        />
