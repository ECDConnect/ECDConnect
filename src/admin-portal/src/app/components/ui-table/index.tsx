  ...
  return (
    <div className="w-full overflow-hidden rounded-lg shadow-lg table-top">
      <div className="relative p-2 px-4 text-gray-400 bg-gray-50 focus-within:text-gray-600">
        <input
          className="block w-full py-2 pl-10 pr-3 leading-5 text-gray-900 placeholder-gray-500 bg-white border border-transparent rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-primary focus:ring-white focus:border-white sm:text-sm"
          placeholder="Search..."
          onChange={search}
        />
      </div>
