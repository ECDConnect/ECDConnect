...
create table public."ReasonForLeavingPractitioner" (
	"Id" uuid NOT NULL,
...
INSERT INTO public."ReasonForLeavingPractitioner"
("Id", "IsActive", "InsertedDate", "UpdatedDate", "UpdatedBy", "TenantId", "Description")
VALUES('06eefbbd-ee77-4d02-9dae-dea3608742c9', true, NOW(), NOW(), null, null, 'CouldNotFindChildren');
INSERT INTO public."ReasonForLeavingPractitioner"
("Id", "IsActive", "InsertedDate", "UpdatedDate", "UpdatedBy", "TenantId", "Description")
VALUES('512e06fb-5805-4207-9b87-4fba4ea00f12', true, NOW(), NOW(), null, null, 'NotInterestedInECD');
INSERT INTO public."ReasonForLeavingPractitioner"
("Id", "IsActive", "InsertedDate", "UpdatedDate", "UpdatedBy", "TenantId", "Description")
...
ALTER TABLE public."Practitioner" ADD "ReasonForLeavingPractitionerId" uuid NULL;
ALTER TABLE public."Practitioner" ADD CONSTRAINT "FK_Practitioner_ReasonForLeavingPractitioner_ReasonForLeavingPractitionerIdId" FOREIGN KEY ("ReasonForLeavingPractitionerIdId") REFERENCES public."ReasonForLeavingPractitioner"("Id") ON DELETE RESTRICT;
