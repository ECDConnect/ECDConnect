...
string userId, int year, int month)
        ...
        private List<IncomeExpensePDFHeaderModel> getIncomePDFHeader(bool includeDescription, bool includeChild, bool includeAmount, bool includeType, bool includeItem)
        {
            List<IncomeExpensePDFHeaderModel> headers = new List<IncomeExpensePDFHeaderModel>();
