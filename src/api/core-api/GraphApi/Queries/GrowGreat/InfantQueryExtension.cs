...
namespace EcdLink.Api.CoreApi.GraphApi.Queries.GrowGreat {
    ...
    public class InfantQueryExtension
    {
        ...
        [Permission(PermissionGroups.USER, GraphActionEnum.View)]
         ...
         [Permission(PermissionGroups.USER, GraphActionEnum.View)]
         public Progress_VisitDataStatus GetPreviousVisitInformationForInfant([Service] VisitManager visitManager, [Service] VisitDataStatusManager visitDataStatusManager, string id) {
