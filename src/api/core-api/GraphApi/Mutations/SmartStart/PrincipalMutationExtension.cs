...
namespace EcdLink.Api.CoreApi.GraphApi.Mutations.SmartStart
{
    ...
    string userId)
            ...
            string userId, string principalId)
        {
            ...
            Practitioner practitioner = practitionerRepo.GetAll().Where(x => x.UserId.Equals(userId)).Where(y => y.PrincipalHierarchy.Equals(principalId)).FirstOrDefault();
            {
     ...
     string oldPrincipalId, string newPrincipalId)
             ...
             string userId)
        {
            ...
            return MapPractitionerToPrincipal(practitionerToPromote);
        }
