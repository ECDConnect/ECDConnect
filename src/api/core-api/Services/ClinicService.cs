...
namespace EcdLink.Api.CoreApi.Services
{
    public class ClinicService : IClinicService
    {
        ...
        public ClinicReportModel GetClinicPointsData(Guid clinicId)
        {
            ...
            var momsTargetPerc = momsPoints == 0 ? 0 : Math.Round((double)momsPoints / (double)momsMax * 100);
            ...
            var childTargetPerc = childPoints == 0 ? 0 : Math.Round((double)childPoints / (double)childMax * 100);
