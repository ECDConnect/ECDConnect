...
namespace EcdLink.Api.CoreApi.Services.Interfaces
{
    public interface ICommunityService
    {
        ...
        public List<CommunityConnectionModel> GetUsersToConnectWith(List<Guid> provinceIds = null, List<Guid> communitySkillIds = null, List<string> connectionTypes = null);
        public List<CommunityConnectionModel> GetOtherConnections(List<Guid> provinceIds = null, List<Guid> communitySkillIds = null);
