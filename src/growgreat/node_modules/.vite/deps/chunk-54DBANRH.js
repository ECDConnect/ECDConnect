...
var FormProvider = (props) => React.createElement(HookFormContext.Provider, { value: omit(props, "children") }, props.children);
...
var tearDown = (_unsubscribe) => {
  if (_unsubscribe.current) {
    _unsubscribe.current.unsubscribe();
    _unsubscribe.current = void 0;
  }
};
var updateSubscriptionProps = ({ _unsubscribe, props }) => () => {
  if (props.disabled) {
...
function useFormState(props) {
  ...
  useSubscribe({
    disabled,
    callback: (formState2) => shouldSubscribeByName(_name.current, formState2.name) && shouldRenderFormState(formState2, _localProxyFormState.current) && updateFormState(Object.assign(Object.assign({}, control._formState), formState2)),
...
function useController(props) {
  ...
  const updateMounted = React.useCallback((name2, value2) => {
...
var getFieldValueAs = (value, { valueAsNumber, valueAsDate, setValueAs }) => isUndefined(value) ? value : valueAsNumber ? value === "" ? NaN : +value : valueAsDate ? new Date(value) : setValueAs ? setValueAs(value) : value;
var defaultReturn = {
  isValid: false,
  value: null
};
  ...
  while (++index < values.length) {
    for (const key in values[index]) {
      if (Array.isArray(values[index][key])) {
        ...
        !isNullOrUndefined(defaultValues) && deepEqual(get(defaultValues[index] || {}, key), values[index][key]) ? set(dirtyFields[index] || {}, key) : dirtyFields[index] = Object.assign(Object.assign({}, dirtyFields[index]), { [key]: true });
      }
    }
...
function createFormControl(props = {}) {
  ...
  const handleChange = async (event) => {
    ...
    if (field) {
      ...
      if (shouldSkipValidation) {
        return shouldRender && _subjects.state.next(Object.assign({ name }, isWatched ? {} : fieldState));
      }
      ...
      if (_options.resolver) {
        ...
        if (isCheckBoxInput(target) && !error) {
          ...
          if (Array.isArray(parentField) && parentField.every((field2) => field2._f && isCheckBoxInput(field2._f.ref))) {
  ...
  const register = (name, options = {}) => {
    ...
    return isWindowUndefined ? { name } : Object.assign(Object.assign({ name }, isBoolean(options.disabled) ? { disabled: options.disabled } : {}), { onChange: handleChange, onBlur: handleChange, ref: (ref) => {
      if (ref) {
        register(name, options);
        let field2 = get(_fields, name);
        const fieldRef = isUndefined(ref.value) ? ref.querySelectorAll ? ref.querySelectorAll("input,select,textarea")[0] || ref : ref : ref;
        const isRadioOrCheckbox = isRadioOrCheckboxFunction(fieldRef);
        if (fieldRef === field2._f.ref || isRadioOrCheckbox && compact(field2._f.refs || []).find((option) => option === fieldRef)) {
          return;
        }
        field2 = {
          _f: isRadioOrCheckbox ? Object.assign(Object.assign({}, field2._f), { refs: [
            ...compact(field2._f.refs || []).filter(live),
            fieldRef
          ], ref: { type: fieldRef.type, name } }) : Object.assign(Object.assign({}, field2._f), { ref: fieldRef })
        };
        set(_fields, name, field2);
...
function useForm(props = {}) {
  ...
  useSubscribe({
    subject: control._subjects.state,
    callback: (formState2) => {
      if (shouldRenderFormState(formState2, control._proxyFormState, true)) {
        control._formState = Object.assign(Object.assign({}, control._formState), formState2);
...
//# sourceMappingURL=chunk-54DBANRH.js.map
