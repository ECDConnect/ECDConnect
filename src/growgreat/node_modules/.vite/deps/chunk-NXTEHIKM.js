import {
  ...
  setMode,
  win
} from "./chunk-EY6L6YAE.js";
import {
  __awaiter,
  __generator,
  __rest
} from "./chunk-XYUTXQPJ.js";
import {
  require_react_dom
} from "./chunk-JECWN45C.js";
import {
  require_react
} from "./chunk-XXHA6ACI.js";
import {
  __toESM
...
var patchEsm = function() {
  if (!(CSS && CSS.supports && CSS.supports("color", "var(--c)"))) {
    return import("./css-shim-2ccf4dec-JMMI6AWE.js").then(function() {
...
// ../../node_modules/@ionic/react/node_modules/ionicons/dist/esm-es5/index-f392fe63.js
...
// ../../node_modules/@ionic/react/node_modules/ionicons/dist/esm-es5/utils-b4648582.js
var CACHED_MAP;
...
// ../../node_modules/@ionic/react/node_modules/ionicons/icons/index.mjs
...
var createPointerEvents = function(e, r, t, a, n) {
  ...
  var d = function(a2) {
    ...
    if (!u && t) {
      u = addEventListener2(e, "touchmove", t, n);
    }
    if (!s) {
      s = addEventListener2(a2.target, "touchend", p, n);
    }
    if (!v) {
      v = addEventListener2(a2.target, "touchcancel", p, n);
    }
  };
  var m = function(a2) {
    if (l > Date.now()) {
    ...
    if (!c) {
      c = addEventListener2(getDocument(e), "mouseup", E, n);
    }
  };
  var p = function(e2) {
    _();
  ...
  var X = function(r2) {
    ...
    if (!r2) {
      ...
      if (!i) {
        i = addEventListener2(e, "touchstart", d, n);
      }
      if (!f) {
        f = addEventListener2(e, "mousedown", m, n);
      }
    }
  };
  var Y = function() {
...
var createGesture = function(e) {
  ...
  var D = createPointerEvents(i.el, g, y, T, { capture: false, passive: d });
  var P = function() {
    h();
    D.stop();
    if (o) {
...
// ../../node_modules/@ionic/core/dist/esm-es5/index-1e16c550.js
...
// ../../node_modules/@ionic/core/dist/esm-es5/overlays-a62f858b.js
...
var setupConfig = function(e) {
  ...
  i.Ionic = i.Ionic || {};
  i.Ionic.config = Object.assign(Object.assign({}, i.Ionic.config), e);
  return i.Ionic.config;
};
var setupSwiperInIonic = function(e, i) {
  if (i === void 0) {
    i = true;
  }
  if (typeof window === "undefined") {
    ...
    if (i) {
      ...
      if (r.tagName === "DIV") {
        var a = new MutationObserver(function(i2) {
          var o2 = i2[0];
          var t2 = o2.oldValue === null;
          var s2 = r.classList.contains("ion-page");
          if (t2 && s2) {
            a.disconnect();
            setupSwiperInIonic(e, false);
          }
        });
        a.observe(r, { attributeFilter: ["class"], attributeOldValue: true });
      }
    }
    return;
  }
  var s = o.closest("ion-modal, ion-popover");
  if (s) {
    var n = s.tagName === "ION-MODAL" ? "ionModalWillPresent" : "ionPopoverWillPresent";
    var l = function() {
      raf(function() {
        o.swiper.update();
        removeEventListener(s, n, l);
      });
    };
    addEventListener(s, n, l);
  } else {
    var d = new MutationObserver(function(e2) {
      var i2;
      var r2 = e2[0];
      var a2 = (i2 = r2.oldValue) === null || i2 === void 0 ? void 0 : i2.includes("ion-page-invisible");
      var s2 = t.classList.contains("ion-page-invisible");
      if (!s2 && s2 !== a2) {
        o.swiper.update();
      }
    });
    d.observe(t, { attributeFilter: ["class"], attributeOldValue: true });
  }
  var c = function() {
    o.swiper.update();
    removeEventListener(window, "appload", c);
  };
  addEventListener(window, "appload", c);
};
var IonicSwiper = { name: "ionic", on: { afterInit: function(e) {
...
var createOverlayComponent = (displayName, controller) => {
  ...
  class Overlay extends import_react.default.Component {
    ...
    render() {
      return import_react_dom.default.createPortal(this.props.isOpen || this.isDismissing ? this.props.children : null, this.el);
    }
  }
  return import_react.default.forwardRef((props, ref) => {
    return import_react.default.createElement(Overlay, Object.assign({}, props, { forwardedRef: ref }));
 ...
 */
//# sourceMappingURL=chunk-NXTEHIKM.js.map
