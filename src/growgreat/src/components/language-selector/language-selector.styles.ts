export const localeDropDownWrapper = 'flex justify-between items-stretch py-2';
...
export const languageLabel =
  'font-medium flex items-center justify-start font-body text-textLight pr-2 mt-1';
