    ...
    () => (
      <>
        ...
        <Button
          ...
          iconPosition="start"
          onClick={navigate(ROUTES.CLIENT.VISIT.PREGNANCY_VISITS)}
        />
        ...
        <Button
          ...
          iconPosition="start"
          onClick={navigate(ROUTES.CLIENT.VISIT.CHILD_VISITS)}
        />
      </>
    ),
    ...
    >
      ...
      <div className="flex h-full flex-col justify-end">
        <Button
          ...
          iconPosition="start"
          onClick={navigate(ROUTES.CLIENT.VISIT.START_VISIT)}
        />
        <Button
          text="Book a visit"
          icon="CalendarIcon"
          ...
          className="w-full"
          iconPosition="start"
          onClick={navigate(ROUTES.CLIENT.VISIT.BOOK_VISIT)}
        />
      </div>
    </div>
  );
