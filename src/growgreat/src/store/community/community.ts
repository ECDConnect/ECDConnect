...
import {
  getAllCommunitySectionItemGG,
  getCommunitySectionGG,
...
const communitySlice = createSlice({
  ...
  extraReducers: (builder) => {
    setThunkActionStatus(builder, getCommunitySectionGG);
    setThunkActionStatus(builder, getAllCommunitySectionItemGG);

    builder.addCase(getCommunitySectionGG.fulfilled, (state, action) => {
      state.connectSectionData = action.payload;
      setFulfilledThunkActionStatus(state, action);
    });
    builder.addCase(getAllCommunitySectionItemGG.fulfilled, (state, action) => {
