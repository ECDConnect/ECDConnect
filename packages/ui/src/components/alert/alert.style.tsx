...
export const wrapper = (style: string) =>
  ` ${style !== 'flat' && 'rounded-md border'} p-4`;
...
export const list = ' list-disc pl-4';
...
const getIcon = (iconName: string, colorType: string) => {
  return renderIcon(iconName, icon + alertColor(colorType, 'outlined'));
};
