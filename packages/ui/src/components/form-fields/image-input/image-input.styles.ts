...
export const containerStyle = 'border-uiLight';
...
export const labelStyle = 'mb-1 block';
export const imageContainer =
  'w-full bg-center bg-contain bg-no-repeat p-9 flex flex-col flex-1 justify-center items-center';
