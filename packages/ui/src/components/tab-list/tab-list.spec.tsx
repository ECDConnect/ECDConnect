...
describe('TabsComponent', () => {
  it('should render successfully', () => {
    ...
    const tabItems = [
      { title: 'Attendance', initActive: false, child: <div>Attendance Coming Soon</div> } as TabItem,
      { title: 'Children', initActive: false, child: <div>Children Coming Soon</div> } as TabItem,
