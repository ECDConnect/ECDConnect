export const contentWrapper = 'flex flex-row items-center px-4 py-4 sm:px-6 justify-between';
...
export const menuTitle = 'font-medium text-textMid truncate';
export const menuSubTitle = 'mt-0 flex items-center text-sm text-textLight';
