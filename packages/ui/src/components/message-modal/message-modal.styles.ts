export const wrapper =
  'px-4 flex flex-col w-full justify-evenly relative items-center pb-4 bg-infoMain';
...
export const closeWrapper =
  'flex absolute top-1.5 right-0.5 items-center mb-2 pr-1';

export const iconRound = 'rounded-full p-3 bg-infoDark';
