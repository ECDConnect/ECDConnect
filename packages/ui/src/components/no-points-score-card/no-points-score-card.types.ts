...
export declare type PointsToDoItemModel = {
  notPartOfPreschool: boolean;
  plannedOneDay: boolean;
  savedIncomeOrExpense: boolean;
  signedUpForApp: boolean;
  viewedCommunitySection: boolean;
};
